...
|---|---|---|---|---|---|
| [`build-exe.yml`](build-exe.yml) | Windows Standalone EXE | `windows-latest` | PyInstaller | `dist/MyApp/` folder | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
| [`build-msi.yml`](build-msi.yml) | Windows MSI Installer | `windows-latest` | WiX Toolset v3 + PyInstaller | `MyApp.msi` installer | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
| [`build-msix.yml`](build-msix.yml) | Windows MSIX Package | `windows-latest` | makeappx + PyInstaller | `MyApp.msix` package | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
| [`build-deb.yml`](build-deb.yml) | Debian/Ubuntu DEB | `ubuntu-22.04` | dpkg-buildpackage + lintian | `*.deb` package | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
| [`build-rpm.yml`](build-rpm.yml) | RHEL/Fedora/CentOS RPM | `ubuntu-22.04` (Fedora container) | rpmbuild + rpmlint | `*.rpm` package | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
| [`build-apk.yml`](build-apk.yml) | Android APK | `ubuntu-22.04` | Buildozer + JDK 17 | Signed/aligned release APK | [Setup Guide ➔](#how-to-set-up-and-adapt-workflows-for-your-project) |
